          ...
          {products.map((product) => (
            ...
            >
              <div className="border-2  border-black mb-2">
                <img
                  src={`http://localhost:3000/uploads/${product.productThumbnail}`}
                  alt={product.productName}
                  className="w-full h-50"
                  onLoad={() => console.log("🎉 DASHBOARD IMAGE LOADED:", product.productThumbnail)}
                  onError={() => console.log("💥 DASHBOARD IMAGE FAILED:", product.productThumbnail)}
                />
              </div>
