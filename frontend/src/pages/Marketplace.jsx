    ...
    return (
      <div className="border-2 border-black shadow-[4px_4px_0px_0px_black] p-4 w-72">
        <div className="border-2 border-black shadow-[4px_4px_0px_0px_black] mb-3 h-40 flex items-center justify-center bg-white">
          <img
            src={`http://localhost:3000/uploads/${productThumbnail}`}
            alt={productName}
            className="max-h-full max-w-full object-contain"
            onLoad={() => console.log("🎉 MARKETPLACE IMAGE LOADED:", productThumbnail)}
            onError={() => console.log("💥 MARKETPLACE IMAGE FAILED:", productThumbnail)}
          />
        </div>
